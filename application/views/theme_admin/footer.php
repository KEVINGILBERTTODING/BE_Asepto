...
<body>
  ...
  <footer class="footer" style="background: #202124;">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
      <span class="text-white text-center text-sm-left  d-block d-sm-inline-block ml-4" style="font-size:16px;">Copyright © 2022 <a href="https://keitoto.com/"  style="color:#0277fa;">Keitoto</a></span>
