                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="text-right">
                                <a href="<?php echo base_url('user/login_karyawan'); ?>" class="btn btn-primary">Karyawan</a>
                                <a href="<?php echo base_url('user/login_admin'); ?>" class="btn btn-warning ml-3">Admin</a>
                            </div>
                            <br>
                            <div class="text-left">
                                <h1 class="h6 text-white-900 mb-4 ">Silahkan masukan nama dan email dibawah ini :</h1>

                            </div>
                            <?php echo form_open('user/login_karyawan'); ?>
                            ...
                            <img src="" alt="" class="rounded mb-4" style="width:16; height:16px;">
                        </div>
                    </div>
                </div>
            </div>
