      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-12 text-white" style="background: #2c2d30;">
            ...
            <form class="user" action="<?php echo base_url(); ?>/admin/Pembayaran/halaman_edit/<?= $data->id_pembayaran ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Masukan Nominal Dibayarkan" name="nominal_dibayarkan" value="" required>
                </div>
              </div>
              <div class="form-group">
