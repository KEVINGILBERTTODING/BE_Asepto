            ...
            <div class="card-body p-0">
                ...
                <div class="row" style="background: #2c2d30;">
                    ...
                    <div class="col-lg-7">
                        ...
                        <form class="user" action="<?= base_url('user/proses_lupa_password'); ?>" method="POST" enctype="multipart/form-data">

                            <div class="form-group">
                                <input type="hidden" class="form-control" name="admin_id" value="<?php $data->admin_id; ?>">
                            </div>

                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="exampleInputUsername1">Password Baru</label>
                                    <input type="text" class="form-control form-control-user" placeholder="***" name="password1" required>
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0">
